          ...
          <div className="space-y-6 animate-fade-in">
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-gray-600">Cards, UPI, Wallets (Mock Payment)</p>
                  </div>
                </button>
                ...
                >
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-gray-600">UPI Payment (Mock Payment)</p>
                  </div>
                </button>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              <p className="text-sm text-yellow-800">
                <strong>Note:</strong> This is a mock payment system. No real transaction will occur. 
                In production, real payment gateway integration will be used.
              </p>
            </div>
